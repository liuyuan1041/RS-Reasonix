...
export const zh: Record<DictKey, string> = {
  ...
  "heartbeat.noTasks": "暂无心跳任务。点击「添加任务」创建一个。\n\n提示：AI 代理也可直接编辑 RS-Reasonix 用户状态目录中的 heartbeat-tasks.json。",
  "heartbeat.every": "每",
  ...
  "heartbeat.configHint": "AI 代理也可直接编辑 RS-Reasonix 用户状态目录中的 heartbeat-tasks.json。",
  ...
  "memory.emptySavedBody": "只保存对后续 RS-Reasonix 会话有帮助的长期背景。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。重启 RS-Reasonix 后加载新的 hooks。",
  "settings.hooksProjectHint": "保存在当前工作区。项目 hooks 需要信任，并在重启 RS-Reasonix 后加载。",
  ...
  "performanceReport.title": "RS-Reasonix 检测到响应卡顿",
