...
export const en = {
  ...
  "heartbeat.noTasks": "No heartbeat tasks yet. Click \"Add task\" to create one.\n\nTip: AI agents can also edit heartbeat-tasks.json in the RS-Reasonix user state folder.",
  ...
  "heartbeat.configHint": "AI agents can also edit heartbeat-tasks.json in the RS-Reasonix user state folder.",
  ...
  "settings.botInstallSubtitle": "Once connected, RS-Reasonix can be used from chat.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart RS-Reasonix to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a RS-Reasonix restart.",
  ...
  "updater.autoCheckHint": "When off, RS-Reasonix won't check automatically when it opens. You can still check manually here.",
  ...
  "updater.installing": "Installing — RS-Reasonix will restart…",
  ...
  // crash page
  "crash.title": "RS-Reasonix hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "RS-Reasonix noticed a responsiveness issue",
