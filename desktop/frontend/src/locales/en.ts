...
export const en = {
  ...
  "sidebar.navigation": "RS-RS-Reasonix navigation",
  ...
  // welcome / empty state
  "welcome.title": "Welcome to RS-RS-Reasonix",
  ...
  // composer
  "composer.placeholder": "Message RS-RS-Reasonix…  ( / commands · @ files · ! shell )",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future RS-RS-Reasonix sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit RS-RS-Reasonix",
  ...
  "settings.botInstallSubtitle": "Once connected, RS-RS-Reasonix can be used from chat.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files RS-RS-Reasonix keeps referencing.",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from RS-RS-Reasonix presets for DeepSeek and Mimo.",
  ...
  "settings.hooksGlobalHint": "Saved globally. New RS-RS-Reasonix sessions load it after /new or restart.",
  ...
  "updater.autoCheckHint": "When off, RS-RS-Reasonix won't check automatically when it opens. You can still check manually here.",
  ...
  "onboarding.title": "Connect RS-RS-Reasonix",
  ...
  // crash page
  "crash.title": "RS-RS-Reasonix hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "mock.askQ2Header": "RS-RS-Reasonix build",
